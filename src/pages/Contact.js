              ...
              <ul className="flex flex-col gap-8 ">
                ...
                <li className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-lg leading-10">
                    Follow us on our social media channels to stay updated on the latest news, tips, and insights in carbon reduction and sustainability.
At Carbon Shredder, your input is essential in shaping a sustainable future. We're excited to connect with you!
